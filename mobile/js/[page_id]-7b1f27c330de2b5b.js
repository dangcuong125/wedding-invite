  ...
  [4600],
  {
    ...
    71497: function (e, t, n) {
      ...
      t.default = function (e) {
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.prev = 0), (e.next = 3), (0, d.tt)(i);
                          case 3:
                            e.next = 8;
                            break;
                          case 5:
        ...
        var R = JSON.parse(h().decompress(h().decodeBase64(n.pageData))),
          S = (0, p.useState)(!0),
          Z = S[0],
          A = S[1],
          I = (0, p.useState)(R),
        ...
        (0, p.useEffect)(function () {
          var e = function () {
            ...
            var e = parseInt(R.ROOT.props.width),
              ...
              a = Math.max(t * i, window.innerHeight),
              o = Object.entries(R).reduce(function (e, t) {
                var n = (0, s.Z)(t, 2),
                  r = n[0],
                  a = n[1];
                if (!a.props) return (e[r] = a), e;
                var o = C(
                  C({}, a.props),
                  {},
                  {
                    ...
                    height: a.props.height * i,
                    fontSize: a.props.fontSize * i,
                  }
                );
                return (e[r] = C(C({}, a), {}, { props: o })), e;
              }, {}),
              c = R.ROOT.props,
              l = (c.editorViewportWidth, (0, r.Z)(c, L));
            (o.ROOT = C(
              C({}, R.ROOT),
              {},
              {
                props: C(C({}, l), {}, { width: window.innerWidth, height: a }),
              }
            )),
              M(o),
              setTimeout(
        ...
        var W = (0, _.g)(n.categoryId),
          B = n.pageName || "Thiệp online",
          J = n.description
            ? n.description
            : "".concat(B, " - ").concat(W, " tr\xean"),
          V = n.thumbnailKey
            ? (0, N.eQ)(n.thumbnailKey)
            : "".concat(j.Z.APP_URL, "/cinelove-default-thumbnail.jpg"),
          F =
            (null === (t = n.openingEffect) || void 0 === t
              ? void 0
              : t.duration) * 1e3 || 2e3;
        return n.reachLimit
          ? (0, E.jsx)(D.Z, {})
          : (0, E.jsxs)(E.Fragment, {
              children: [
                (0, E.jsx)(O.PB, {
                  title: B,
                  titleTemplate: "%s",
                  defaultTitle: "Ngọc Cường & Khánh Huyền",
                  description: J,
                  canonical: "".concat(j.Z.APP_URL, "/s/").concat(i),
                  openGraph: {
                    type: "website",
                    locale: "vi_VN",
                    url: "".concat(j.Z.APP_URL, "/s/").concat(i),
                    title: B + "",
                    description: J,
                    images: [{ url: V, secureUrl: V, alt: B }],
                ...
                (0, E.jsx)(b.Z, {
                  ...
                  pageData: n,
                  hasEnvelope: U,
                  children: (0, E.jsxs)(y.l, {
                    isProcessing: Z,
                    className: "h-full",
                    scrollSpeed: 0.06,
                    initialDelay: F,
                    rootBackground: z.ROOT.props.backgroundColor,
                    hasEnvelope: U,
                    children: [
                      Z &&
                        !n.openingEffect &&
  ...
  function (e) {
    e.O(
      ...
      [
        ...
        8499, 5593, 5861, 2352, 1004, 1109, 7531, 5518, 1365, 1473, 7637, 1099,
        221, 6214, 2545, 8593, 1476, 818, 6199, 5435, 8238, 8534, 4304, 1637,
        9774, 2888, 179,
      ],
      function () {
        return e((e.s = 43535));
