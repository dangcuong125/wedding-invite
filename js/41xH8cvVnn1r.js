      ...
      t.Z = function (e) {
        ...
        i)
          ...
          : (0, x.jsxs)("div", {
              ...
              children: [
                t &&
                  (0, x.jsx)("h3", { className: "jsx-304459550", children: t }),
                (0, x.jsx)("div", {
      ...
      var i,
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          U.Z.get(
                            "".concat(D.Z.API_URL, "/file-upload/user/audios")
                          )
                        );
                      case 2:
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          U.Z.get(
                            "".concat(D.Z.API_URL, "/api/resources/music")
                          )
                        );
                      case 2:
                        return (t = e.sent.data), e.abrupt("return", t);
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          U.Z.get(
                            "".concat(D.Z.API_URL, "/file-upload/user/count")
                          )
                        );
                      case 2:
                        return (t = e.sent.data), e.abrupt("return", t);
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (e.next = 2),
                          U.Z.delete(
                            "".concat(D.Z.API_URL, "/file-upload/").concat(t)
                          )
                        );
                      case 2:
                        return (n = e.sent.data), e.abrupt("return", n);
        ...
        I = function (e) {
          ...
          var I =
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.prev = 0), u(!0), (e.next = 4), S.getAllMusic()
                            );
                          case 4:
                            (t = e.sent),
                              o(
                                (0, g.Z)(t).sort(function (e, t) {
                          ...
                          case 13:
                            return (e.prev = 13), u(!1), e.finish(13);
                          case 16:
                          case "end":
                            return e.stop();
                        }
            ...
            z = function (e) {
              m === "".concat(D.Z.CDN_URL, "/").concat(e.fileKey)
                ? b(null)
                : b(e.fileKey);
            },
            O = function (e, t) {
                        ...
                        return (0, h.jsxs)(
                          "div",
                          {
                            ...
                            className:
                              ...
                              "music-item ".concat(
                                m ===
                                  "".concat(D.Z.CDN_URL, "/").concat(e.fileKey)
                                  ? "playing"
                                  : ""
                              ),
                            children: [
        ...
        O = function () {
          ...
          return (0, h.jsxs)("div", {
            ...
            children: [
              ...
              (0, h.jsx)(b, { selectedCategory: r, onSelectCategory: s }),
              (0, h.jsx)(I, { category: r, searchText: t }),
              (0, h.jsx)(d(), {
                id: "1181673406",
                children: [
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.prev = 0), g(!0), (e.next = 4), S.getMyMusic()
                            );
                          case 4:
                            U(e.sent), (e.next = 11);
                            break;
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          t.preventDefault(),
                            o(!1),
                            (n = t.dataTransfer.files[0]) && q(n) && H(n);
                        case 4:
                        case "end":
                          return e.stop();
                      }
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 4:
                            return (
                              (n = e.sent),
                              (e.next = 7),
                              S.getPresignedUrl(t.name, t.type, n.toString())
                            );
                          case 7:
                            return (
                              (i = e.sent),
                              (e.next = 10),
                              S.uploadWithPresignedUrl(t, i.uploadUrl)
                            );
                          case 10:
                            if (e.sent) {
                              e.next = 13;
                          ...
                          case 13:
                            return (
                              (e.next = 15), S.confirmUpload(i.fileId, t.size)
                            );
                          case 15:
                            return (
                              w.ZP.success(
                                        ...
                                        switch ((e.prev = e.next)) {
                                          case 0:
                                            return (
                                              (e.prev = 0),
                                              (e.next = 3),
                                              S.deleteUserFileMusic(t.fileId)
                                            );
                                          case 3:
                                            return (
                                              w.ZP.success(
                  ...
                  (0, h.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, h.jsxs)("p", {
                        ...
                        children: ["G\xf3i hiện tại: ", E.toUpperCase()],
                      }),
                    ],
                  }),
                  (0, h.jsx)(d(), {
            ...
            (0, f.useEffect)(
              function () {
                if (a.current) {
                  var e = r || i;
                  if (t && e) {
                    var s = e.includes("/mp3/")
                      ? e.replace(D.Z.CDN_URL, D.Z.CDN_MP3_URL)
                      : e;
                    (a.current.src = s), a.current.play();
                  } else a.current.pause(), n(!1);
                }
              },
              [t, r, i]
            ),
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 10:
                          (e.prev = 10),
                            ...
                            null == r || r(e.t0);
                        case 13:
                          return (e.prev = 13), w(!1), e.finish(13);
                        case 16:
                        case "end":
                          return e.stop();
                      }
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (
                          c.ZP.error(
                            "Mật khẩu kh\xf4ng đ\xfang. Vui l\xf2ng kiểm tra lại trong phần bio của Facebook/Instagram nhaaaa!"
                          ),
                          e.abrupt("return")
                        );
                      case 3:
          ...
          D = (0, p.jsxs)("div", {
            ...
            children: [
              ...
              (0, p.jsxs)("span", {
                className: "font-bold",
                children: [
                  "gh\xe9 thăm v\xe0 follow trang Facebook hoặc Instagram ",
                  " ",
                ],
              }),
              "nhaaaa!",
              ...
              (0, p.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, p.jsx)("div", {
                    ...
                    children:
                      "\uD83D\uDCA1 Cảm ơn bạn đ\xe3 ủng hộ! H\xe3y follow Facebook v\xe0 Instagram để nhận những website miễn ph\xed mới nhất nh\xe9! \uD83C\uDF1F",
                  }),
                ],
              }),
              (0, p.jsx)(u.Z, {}),
              (0, p.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, p.jsx)(l.ZP, {
                    ...
                    loading: void 0 !== j && j,
                    size: "large",
                    children: void 0 === g ? "X\xe1c thực v\xe0 tiếp tục" : g,
                  }),
                ],
              }),
            ],
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsx)("img", {
                  src: "".concat(s.Z.CDN_URL, "/assets/").concat(i, ".png"),
                  alt: "music icon",
