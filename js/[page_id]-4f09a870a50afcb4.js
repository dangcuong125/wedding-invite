  ...
  [9862],
  {
    ...
    13037: function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        var z = JSON.parse(f().decompress(f().decodeBase64(n.pageData))),
          S = (0, p.useState)(!0),
          Z = S[0],
          A = S[1],
          I = (0, p.useState)(z),
        ...
        (0, p.useEffect)(
          function () {
            var e = function () {
              A(!0);
              var e = parseInt(z.ROOT.props.width),
                t = parseInt(z.ROOT.props.height),
                i = B / e,
                a = Math.max(t * i, 0.9 * window.innerHeight),
                s = Object.entries(z).reduce(function (e, t) {
                  var n = (0, o.Z)(t, 2),
                    r = n[0],
                    a = n[1];
                  ...
                  return (e[r] = C(C({}, a), {}, { props: s })), e;
                }, {}),
                c = z.ROOT.props,
                l = (c.editorViewportWidth, (0, r.Z)(c, R));
              (s.ROOT = C(
                C({}, z.ROOT),
                {},
                { props: C(C({}, l), {}, { width: B, height: a }) }
              )),
                U(s),
                setTimeout(
                  function () {
        ...
        var F = (0, D.g)(n.categoryId),
          K = n.pageName || "Thiệp online",
          Q = n.description
            ? n.description
            : "".concat(K, " - ").concat(F, " tr\xean"),
          V = n.thumbnailKey
            ? (0, k.eQ)(n.thumbnailKey)
            : "".concat(O.Z.APP_URL, "/cinelove-default-thumbnail.jpg"),
          X =
              ...
              children: [
                (0, L.jsx)(y.PB, {
                  ...
                  openGraph: {
                    ...
                    title: K + "",
                    description: Q,
                    images: [{ url: V, secureUrl: V, alt: K }],
  ...
  function (e) {
    e.O(
      ...
      [
        ...
        8499, 5593, 5861, 2352, 1004, 1109, 5518, 1365, 7531, 1473, 7637, 1099,
