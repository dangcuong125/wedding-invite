  ...
  [5518],
  {
    85518: function (i, e, o) {
      ...
      var d = o(23451),
        ...
        _ = function (i) {
          return i.type === g.Browser;
        },
        T = function (i) {
          return i.name === v.Edge;
        },
        C = function (i) {
      ...
      c.type,
        ...
        c.type,
        g.Embedded,
        u.name === v.MobileSafari || E(),
        u.name,
        v.Chromium;
      var O = ((a = c.type), a === g.Mobile || a === g.Tablet || E()),
        M = (c.type, g.Mobile, c.type === g.Tablet || E());
      _(c),
        _(c),
        f.name,
        x.Android,
        ...
        v.Firefox,
        (r = u.name),
        r === v.Safari || v.MobileSafari,
        u.name,
        v.Opera,
        (n = u.name),
        n === v.InternetExplorer || v.Ie,
        k(f.version),
        k(f.name),
        k(u.version),
        k(u.major),
        ...
        S("iPod"),
        (s = y()),
        (b = s && s.userAgent && s.userAgent.toLowerCase()),
        "string" == typeof b && /electron/.test(b),
        C(h),
        T(u) && C(h),
        f.name,
        x.Windows,
          ...
          J = function (i, e) {
            ...
            return (
              ...
              (this.setUA = function (i) {
                return (
                  (a = typeof i === w && i.length > 500 ? $(i, 500) : i), this
                );
              }),
              this.setUA(a),
              this
